...
12. Update `ClaudeTool` and `ToolFrontmatter::Tasks` mapping to reflect `TodoWrite` deprecation
...
13. Support compiling a single spec (or subset) and emitting expanded output to stdout
