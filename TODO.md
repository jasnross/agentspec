...
11. Preserve verbatim file modes for all `SupportingFile` emission
...
12. Move provider-specific JSON-merge knowledge into adapters
...
13. Provider-payload translation shim for hook scripts
...
14. Allow specifying multiple events for a single hook in `hooks.toml`
...
15. CST-aware tidy for `opencode.json` (parity with Claude/Cursor)
...
16. Verbose parity for `agentspec remove`
