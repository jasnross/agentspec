#!/usr/bin/env bash
# Does Cursor parse multiple comma-separated bracket options in subagent
# frontmatter?
#
...
probe_human_run "$package" cursor-subagent-model-options "
  ...
  3. Invoke the \"arm-two-options\" subagent.
