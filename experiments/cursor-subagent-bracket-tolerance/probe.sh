#!/usr/bin/env bash
# Does a bracket carrying an option Cursor's oracle cannot observe still apply
# the options it can?
#
...
probe_human_run "$package" cursor-subagent-bracket-tolerance "
  ...
  3. Invoke the \"arm-bracket-tolerance\" subagent.
